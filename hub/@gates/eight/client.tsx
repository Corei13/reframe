...
import { Button, Y } from "npm:@retune.so/sdk@latest/ui";
import confetti from "npm:canvas-confetti@1.6.0";

export * from "npm:canvas-confetti@1.6.0";

export * from "npm:@retune.so/sdk@latest/ui";
...
export const Files = ({ files }: { files: File[] }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-bold bg-primary-400 text-white">Files (v45)</h1>
