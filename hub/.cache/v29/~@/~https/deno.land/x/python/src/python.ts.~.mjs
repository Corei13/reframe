export default async (reframe_7spjk2irahf) => {
    import.meta.path = "/~https/deno.land/x/python/src/python.ts";
    const imports_02kd9wc494xh = await reframe_7spjk2irahf.importMany("./ffi.ts", "./util.ts");
    let exports_hd53narc0z = {};
    exports_hd53narc0z[Symbol.toStringTag] = "Module";
    const { py: py } = imports_02kd9wc494xh["./ffi.ts"];
    const { cstr: cstr, SliceItemRegExp: SliceItemRegExp } = imports_02kd9wc494xh["./util.ts"];
    const refregistry = new FinalizationRegistry(py.Py_DecRef);
    const ProxiedPyObject = Symbol("ProxiedPyObject");
    exports_hd53narc0z["ProxiedPyObject"] = ProxiedPyObject;
    class NamedArgument {
        name;
        value;
    ...
    exports_hd53narc0z["Callback"] = Callback;
    class PyObject {
        handle;
        /**
    ...
    exports_hd53narc0z["PyObject"] = PyObject;
    ...
    exports_hd53narc0z["PythonError"] = PythonError;
    ...
    exports_hd53narc0z["maybeThrowError"] = maybeThrowError;
    class Python {
        /** Built-ins module. */
        builtins;
    ...
    exports_hd53narc0z["Python"] = Python;
