export default async (reframe_p1fcljf5ew) => {
    import.meta.path = "/~https/deno.land/x/python/src/ffi.ts";
    const imports_t55is5r03zk = await reframe_p1fcljf5ew.importMany("./symbols.ts", "./util.ts");
    let exports_pjebv7nb62k = {};
    exports_pjebv7nb62k[Symbol.toStringTag] = "Module";
    const { SYMBOLS: SYMBOLS } = imports_t55is5r03zk["./symbols.ts"];
    const { postSetup: postSetup } = imports_t55is5r03zk["./util.ts"];
    const searchPath = [];
...
`);
    ...
    exports_pjebv7nb62k["py"] = py;
    return exports_pjebv7nb62k;
};
