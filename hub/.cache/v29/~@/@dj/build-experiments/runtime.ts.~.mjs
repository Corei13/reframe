export default async () => {
    ...
    ;
    let exports_xjem368k7e7 = {};
    exports_xjem368k7e7[Symbol.toStringTag] = "Module";
    ...
    exports_xjem368k7e7["splitPath"] = splitPath;
    function cleanPath(path) {
        return "/" + splitPath(path).join("/");
    }
    exports_xjem368k7e7["cleanPath"] = cleanPath;
    ...
    exports_xjem368k7e7["splitSpecifier"] = splitSpecifier;
    const joinSpecifier = (loaders, segments) => {
        return (loaders.length === 0 ? "" : loaders.join(":") + ":") +
            segments.join("/");
    };
    exports_xjem368k7e7["joinSpecifier"] = joinSpecifier;
    ...
    exports_xjem368k7e7["mergeSpecifiers"] = mergeSpecifiers;
    ...
    exports_xjem368k7e7["absolute"] = absolute;
    ...
    exports_xjem368k7e7["resolvePath"] = resolvePath;
    ...
    exports_xjem368k7e7["createFromImport"] = createFromImport;
    ...
    exports_xjem368k7e7["createRuntime"] = createRuntime;
    return exports_xjem368k7e7;
};
