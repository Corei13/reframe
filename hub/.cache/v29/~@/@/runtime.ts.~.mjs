export default async (reframe_29rf83sw9nb) => {
    import.meta.path = "/@/runtime.ts";
    const imports_xegiau6m3q = await reframe_29rf83sw9nb.importMany("@dj/build-experiments/runtime.ts", "https://deno.land/x/python/mod.ts");
    let exports_ksxm0utvz4s = {};
    exports_ksxm0utvz4s[Symbol.toStringTag] = "Module";
    const { createFromImport: createFromImport } = imports_xegiau6m3q["@dj/build-experiments/runtime.ts"];
    const { python: python } = imports_xegiau6m3q["https://deno.land/x/python/mod.ts"];
    ...
    exports_ksxm0utvz4s["createRuntime"] = createRuntime;
    return exports_ksxm0utvz4s;
};
