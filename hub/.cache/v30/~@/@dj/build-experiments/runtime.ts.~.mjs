export default async () => {
    ...
    ;
    let exports_8w0dkex9jv = {};
    exports_8w0dkex9jv[Symbol.toStringTag] = "Module";
    ...
    exports_8w0dkex9jv["splitPath"] = splitPath;
    function cleanPath(path) {
        return "/" + splitPath(path).join("/");
    }
    exports_8w0dkex9jv["cleanPath"] = cleanPath;
    ...
    exports_8w0dkex9jv["splitSpecifier"] = splitSpecifier;
    const joinSpecifier = (loaders, segments) => {
        return (loaders.length === 0 ? "" : loaders.join(":") + ":") +
            segments.join("/");
    };
    exports_8w0dkex9jv["joinSpecifier"] = joinSpecifier;
    ...
    exports_8w0dkex9jv["mergeSpecifiers"] = mergeSpecifiers;
    ...
    exports_8w0dkex9jv["absolute"] = absolute;
    ...
    exports_8w0dkex9jv["resolvePath"] = resolvePath;
    ...
    exports_8w0dkex9jv["createFromImport"] = createFromImport;
    ...
    exports_8w0dkex9jv["createRuntime"] = createRuntime;
    return exports_8w0dkex9jv;
};
