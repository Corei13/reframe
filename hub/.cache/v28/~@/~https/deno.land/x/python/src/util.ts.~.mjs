export default async () => {
    ...
    ;
    let exports_cijllz70369 = {};
    exports_cijllz70369[Symbol.toStringTag] = "Module";
    const encoder = new TextEncoder();
    exports_cijllz70369["encoder"] = encoder;
    const decoder = new TextDecoder();
    exports_cijllz70369["decoder"] = decoder;
    const libDlDef = {
        dlopen: {
    ...
    exports_cijllz70369["postSetup"] = postSetup;
    function cstr(str) {
        const buf = new Uint8Array(str.length + 1);
        encoder.encodeInto(str, buf);
        return buf;
    }
    exports_cijllz70369["cstr"] = cstr;
    const SliceItemRegExp = /^\s*(-?\d+)?\s*:\s*(-?\d+)?\s*(:\s*(-?\d+)?\s*)?$/;
    exports_cijllz70369["SliceItemRegExp"] = SliceItemRegExp;
    return exports_cijllz70369;
};
