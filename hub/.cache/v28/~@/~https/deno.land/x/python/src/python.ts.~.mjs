export default async (reframe_ch7nb130grv) => {
    import.meta.path = "/~https/deno.land/x/python/src/python.ts";
    const imports_8t2jd4nlwz8 = await reframe_ch7nb130grv.importMany("./ffi.ts", "./util.ts");
    let exports_835xa0js9h6 = {};
    exports_835xa0js9h6[Symbol.toStringTag] = "Module";
    const { py: py } = imports_8t2jd4nlwz8["./ffi.ts"];
    const { cstr: cstr, SliceItemRegExp: SliceItemRegExp } = imports_8t2jd4nlwz8["./util.ts"];
    const refregistry = new FinalizationRegistry(py.Py_DecRef);
    const ProxiedPyObject = Symbol("ProxiedPyObject");
    exports_835xa0js9h6["ProxiedPyObject"] = ProxiedPyObject;
    class NamedArgument {
        name;
        value;
    ...
    exports_835xa0js9h6["Callback"] = Callback;
    class PyObject {
        handle;
        /**
    ...
    exports_835xa0js9h6["PyObject"] = PyObject;
    ...
    exports_835xa0js9h6["PythonError"] = PythonError;
    ...
    exports_835xa0js9h6["maybeThrowError"] = maybeThrowError;
    class Python {
        /** Built-ins module. */
        builtins;
    ...
    exports_835xa0js9h6["Python"] = Python;
