...
const { createRuntime: createNewRuntime } = await runtime.import("/:" + "/~@/@/runtime.ts");


await createNewRuntime().run(meta.entry);
`;
...
await queue.enqueue("/~@/@/runtime.ts");
